'use strict';var _extends=Object.assign||function(a){for(var b,c=1;c<arguments.length;c++)for(var d in b=arguments[c],b)Object.prototype.hasOwnProperty.call(b,d)&&(a[d]=b[d]);return a};Object.defineProperty(exports,'__esModule',{value:!0});function getSingleValidateHandler(a){var b=a.isEmpty;return b?function(a,b){var c=!0;return b&&(c=b&&a.test(b)),c}:function(a,b){var c=!0;return c=null!=b&&''!==b&&a.test(b),c}}// import Vue from 'vue';
//需要写一个可配置的单例 
...
noBlank:{pattern:/^\S+$/,errorMessage:''},password:{pattern:/^(?=.*[a-zA-Z])(?=.*\d)[a-zA-Z\d]{8}$/,errorMessage:'\u5BC6\u7801\u5E94\u4E3A8\u4F4D\u6570\u5B57\u52A0\u5B57\u6BCD\u7684\u7EC4\u5408'}},b.patterns),this.errorHandler=b.errorHandler}validator.prototype.validate=function(a){var b=this,c=a.params,d=a.isEmpty,e=getSingleValidateHandler({isEmpty:d});/*
  ...
  */return new Promise(function(a){var d=!0,f=!0,g=!1,h=void 0;try{for(var i,j=c[Symbol.iterator]();!(f=(i=j.next()).done);f=!0){var k=i.value,l=k.type,m=k.value,n=k.msg,o=b.patterns[l];// var pattern = global.validaterRegs[type] || patterns[type];
if(o&&(d=e(o.pattern,m),!d))return b.errorHandler({desc:n||b.patterns[l].errorMessage}),void a(d)}}catch(a){g=!0,h=a}finally{try{!f&&j.return&&j.return()}finally{if(g)throw h}}a(d)})},validator.prototype.getPattern=function(a){/**
   * params:
   * {
   *    type:''
   * }
