...
if(p&&('boolean'==typeof o&&(e=getSingleValidateHandler({isEmpty:o})),d=e(p.pattern,m),!d))return b.errorHandler({desc:n||b.patterns[l].errorMessage}),void a(d)}}catch(a){g=!0,h=a}finally{try{!f&&j.return&&j.return()}finally{if(g)throw h}}a(d)})},validator.prototype.getPattern=function(a){/**
   * params:
   * {
   *    type:''
   * }
