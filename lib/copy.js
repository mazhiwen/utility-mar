...
// }
var deepDiff=function(){function a(c,d){if(!isIteration(c))throw new Error('error arguments');var e=unionArray(Object.keys(c),Object.keys(d)),f=!0,g=!1,h=void 0;try{for(var i,j,k=e[Symbol.iterator]();!(f=(i=k.next()).done);f=!0){if(j=i.value,!(c.hasOwnProperty(j)&&d.hasOwnProperty(j)))return void(b=!1);if(isIteration(c[j]))a(c[j],d[j]);else if(d[j]!==c[j])return void(b=!1)}}catch(a){g=!0,h=a}finally{try{!f&&k.return&&k.return()}finally{if(g)throw h}}}var b=null;return function(c,d){return b=!0,a(c,d),b}}();exports.default={deepCopy:deepCopy,deepDiff:deepDiff};